...
// Hướng dẫn sử dụng
const String HELP_BUTTON = "   Button: button1 o pin2.  Bam nut de chuyen che do REMOTE(bluetooth) --> TRACK (find path) -->  BODYGUARD (keep distance)";
...
enum ActionMode{
  ...
  bodyguard=2,  // giu khoang cach voi vat the
